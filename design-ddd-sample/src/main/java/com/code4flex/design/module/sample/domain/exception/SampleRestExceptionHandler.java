package com.code4flex.design.module.sample.domain.exception;


import com.code4flex.design.module.sample.domain.constants.CommonServerErrorConstants;
...
public class SampleRestExceptionHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SampleRestExceptionHandler.class);
